      ...
      const mockDocuments: BillingDocument[] = [
        {
          ...
          currency: '₾',
          status: 'paid',
          description: 'ძირითადი გეგმა - იანვარი 2025',
          downloadUrl: '#',
          emailSent: true,
          createdAt: '2025-01-15T10:30:00Z',
          metadata: {
            planName: 'ძირითადი გეგმა',
            billingPeriod: 'იანვარი 2025',
        ...
        },
        {
          ...
          currency: '₾',
          status: 'paid',
          description: 'გადახდის ქვითარი - INV-2025-001',
          downloadUrl: '#',
          emailSent: false,
        ...
        },
        {
          id: '3',
          type: 'tax_document',
          documentNumber: 'TAX-2025-Q1',
          date: '2025-03-31',
          amount: 87.00,
          currency: '₾',
          status: 'paid',
          description: 'Q1 2025 საგადასახადო ანგარიში',
          downloadUrl: '#',
          emailSent: true,
